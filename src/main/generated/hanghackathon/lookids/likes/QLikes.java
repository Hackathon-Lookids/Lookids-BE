...
public class QLikes extends EntityPathBase<Likes> {
    ...
    private static final long serialVersionUID = -1514690744L;
    ...
    public final hanghackathon.lookids.look.QLook look;
    ...
    public QLikes(Class<? extends Likes> type, PathMetadata metadata, PathInits inits) {
        ...
        this.look = inits.isInitialized("look") ? new hanghackathon.lookids.look.QLook(forProperty("look"), inits.get("look")) : null;
